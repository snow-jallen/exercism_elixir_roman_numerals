defmodule RomanNumerals do
  ...
  defp startsWith(_input = "M" <> rest) do
    {rest, 1000}
  end

  defp startsWith(_input = "CM" <> rest) do
    {rest, 900}
  end

  defp startsWith(_input = "D" <> rest) do
    {rest, 500}
  end

  defp startsWith(_input = "CD" <> rest) do
    {rest, 400}
  end

  defp startsWith(_input = "C" <> rest) do
    {rest, 100}
  end

  defp startsWith(_input = "XC" <> rest) do
    {rest, 90}
  end

  defp startsWith(_input = "L" <> rest) do
    {rest, 50}
  end

  defp startsWith(_input = "XL" <> rest) do
    {rest, 40}
  end

  defp startsWith(_input = "X" <> rest) do
    {rest, 10}
  end

  defp startsWith(_input = "IX" <> rest) do
    {rest, 9}
  end

  defp startsWith(_input = "V" <> rest) do
    {rest, 5}
  end

  defp startsWith(_input = "IV" <> rest) do
    {rest, 4}
  end

  defp startsWith(_input = "I" <> rest) do
    {rest, 1}
  end
